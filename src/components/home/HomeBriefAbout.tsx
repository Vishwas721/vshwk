...
const DESKTOP_TITLE_LINES = [
  {
    text: "IN THE SUMMER OF 24, I STARTED PROGRAMMING. IT WAS LA",
    rotate: 3,
    isRightAlign: true,
    delay: 0,
  ...
  {
    text: "GTH IS RELENTLESS EXECUTION",
    rotate: -3,
    isRightAlign: false,
    delay: 0.36,
 ...
 */
const FOOTER_LINES = [
  "THE ENGINEERING EXPERIMENTS AND AI SYSTEMS I AM BUILDING ON A DAILY BASIS ARE AVAILABLE ON",
  "GITHUB, RANGING FROM AGENTIC PIPELINES TO INTERACTIVE WEBGL EXPERIENCES. NOT",
  "ALL OF MY ARCHITECTURES ARE AVAILABLE PUBLICLY,",
  "BUT YOU CAN EXPLORE THE MAJOR CASE STUDIES IN THIS PORTFOLIO.",
];
          ...
          */}
          ...
          >
            ...
            <span className="block md:hidden">
              THE ENGINEERING EXPERIMENTS AND AI SYSTEMS I AM BUILDING ON A DAILY BASIS ARE AVAILABLE ON
              GITHUB, RANGING FROM AGENTIC PIPELINES TO INTERACTIVE WEBGL EXPERIENCES. NOT ALL OF MY
              ARCHITECTURES ARE AVAILABLE PUBLICLY, BUT YOU CAN EXPLORE THE MAJOR CASE STUDIES IN THIS PORTFOLIO.
            </span>
          </p>
        </div>
      </div>
